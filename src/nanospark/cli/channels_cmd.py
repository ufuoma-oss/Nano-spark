...
# Template for `nanospark channels install <key>` stub (channel key substituted).
...
def list_cmd() -> None:
    ...
    if not config_path.is_file():
        ...
        click.echo("Run `nanospark channels config` to create one.")
        cfg = load_config()
    else:
