# -*- coding: utf-8 -*-
"""NanoSpark Agent - Main agent implementation.

This module provides the main NanoSparkAgent class built on ReActAgent,
...
from .memory import NanoSparkInMemoryMemory
...
class NanoSparkAgent(ReActAgent):
    """NanoSpark Agent with integrated tools, skills, and memory management.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            toolkit=toolkit,
            memory=NanoSparkInMemoryMemory(),
            formatter=formatter,
            max_iters=max_iters,
        )
